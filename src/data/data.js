...
const data = {
  ...
  homeContent: [
    ...
    },
    {
      ...
      text2_en:
        "The user interface is a key element of any web application, therefore it uses the available styling tools, i.e. CSS3, Sass, style-componets and react-bootstrap if the website uses React technologies. However, in my opinion the best way to work in a team and backups is using github. I do not present all the tools I use, because every other project requires different solutions to facilitate work.",
      text2_pl:
        "Interfejs użytkownika to kluczowy element każdej aplikacji internetowej dlatego wykorzytuje dostępne narzędzia do stylizacji czyli CSS3, Sass, style-componets oraz react-bootstrap jeśli strona wykorzystuje technologie React. Natomiast moim zdaniem najlepszym sposobem do pracy w zespole i kopii zapasowych używam github'a. Nie przedstawiam wszystkich narzędzi jakich używam, gdyż każdy inny projekt wymaga różnych rozwiązń ułatwiające pracę."
    },
    {
      key: 2,
      ...
      detailsContenet: [
        {
          ...
          description_en:
            "In this stage of as a beginner, I wanted to build a website that would challenge me and help bring my skills to the next level. I believe this project taught me a many aspects to resolve a problems and patient. This will be not my last project in pure javascript and i hope everyone will see soon new applications. This project also show my other hobbies that i interesting and i hope in the future I could use it for commercial us",
          description_pl:
            "Na tym etapie, jako początkujący, chciałem stworzyć stronę internetową, która rzuciłaby mi wyzwanie i pomogłaby przenieść moje umiejętności na wyższy poziom. Wierzę, że ten projekt nauczył mnie wielu aspektów rozwiązywania problemów i cierpliwości. To nie będzie mój ostatni projekt w czystym javascript i mam nadzieję, że wszyscy wkrótce zobaczą nowe aplikacje. Ten projekt pokazuje również moje inne hobby, które mnie interesują i mam nadzieję, że w przyszłości będę mógł go wykorzystać do celów komercyjnych.",
          m_img: m_tablet
        },
        {
          id: 1,
          title_en: "The technical scene",
          title_pl: "Scena techniczna",
          description_en:
